...
The September 14 branch review and v5 corrections are recorded in `WEBSITE_BRANCH_REVIEW_2026-09-14.md`. Google account linking and event imports require verification in the accounts; source configuration alone does not establish that they are complete.
