...
- `assets/privacy-consent.js` and `assets/privacy-consent.css` are the shared website consent implementation. Advertising measurement has been removed. The script clears the historical local choice when possible and supplies a Website privacy link; it must not load tags or queue events.
